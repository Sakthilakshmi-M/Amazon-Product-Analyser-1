...
def predict():
  try:
      ...
      return render_template('after.html',url_plot='/static/plot.png',name=product_title,url_image=product_image,price=product_price,description=product_description_list,nav_link=target_product)
  except:
